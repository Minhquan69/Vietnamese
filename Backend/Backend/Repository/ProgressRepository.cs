...
namespace Backend.Repository
{
    public interface ProgressRepository
    {
        ...
        Task<List<UserProgress>> GetUserLessons(int userId, int courseId);
        ...
        Task<UserLevel?> GetUserLevelByLevelId(int userId, int levelId);
        Task<List<UserCourse>> GetUserCourses(int userId, int levelId);
        Task<UserProgress?> GetUserLessonByLessonId(int userId, int lessonId);

        Task<bool> HasUserLevel(int userId);
        Task<bool> HasUserCourse(int userId);
        Task<bool> HasUserLesson(int userId);
    }
}
